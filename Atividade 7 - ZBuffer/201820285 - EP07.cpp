...
void Desenha(void) {
    ...
    // PROFUNDIDADE: ao habilitar o DEPTH_TEST, conseguimos perceber a profundidade (não vemos paredes atrás de outras paredes)
    // Ao desabilitar, notamos que conseguimos enxergar paredes que estão atrás.
